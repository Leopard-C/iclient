...
int main() {
    ...
    printf("0. test_url\n");
    printf("1. test_http_get\n");
    printf("2. test_http_post\n");
    printf("3. test_http_put\n");
    ...
    switch (id) {
    case 0: test_url(); break;
    case 1: test_http_get(); break;
    case 2: test_http_post(); break;
    case 3: test_http_put(); break;
